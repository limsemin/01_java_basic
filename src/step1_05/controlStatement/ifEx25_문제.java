...
public class ifEx25_문제 {
	...
	public static void main(String[] args) {
		...
		switch(getChoice) {
		case 1:
			System.out.println("쌀떡볶이 	: 3500 원");
			System.out.println("밀떡볶이 	: 3000 원");
		break;
		case 2:
			System.out.println("찹쌀순대 	: 3500 원");
			System.out.println("피순대    	: 3500 원");
		break;
		case 3:
			System.out.println("오징어 튀김 : 500 원");
			System.out.println("계란말이	: 500 원");
			System.out.println("야채튀김     : 500 원 ");
		break;
		default:
